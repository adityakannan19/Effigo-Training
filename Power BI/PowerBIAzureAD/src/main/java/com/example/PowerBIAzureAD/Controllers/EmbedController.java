package com.example.PowerBIAzureAD.Controllers;
...
import com.example.PowerBIAzureAD.Services.AzureADService;
import com.example.PowerBIAzureAD.Services.PowerBIService;
...
public class EmbedController {
	...
	public ResponseEntity<String> embedInfoController() throws IOException {
		...
		try {
			...
			EmbedConfig reportEmbedConfig = PowerBIService.getEmbedConfig(accessToken, Config.workspaceId,
					Config.reportId);
